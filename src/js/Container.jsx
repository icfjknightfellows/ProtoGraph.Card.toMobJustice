    ...
    if (this.state.schemaJSON === undefined ){
      ...
      return (
        <div id="ProtoScreenshot">
          {copy_paste_from_article.image !== '' ? <img src={copy_paste_from_article.image} style={{width: '100%'}}/> : <img src="https://cdn.protograph.pykih.com/Assets/indianexpress-screenshot.jpg" style={{width: '100%'}}/>}
        </div>
      )
    }
  }
